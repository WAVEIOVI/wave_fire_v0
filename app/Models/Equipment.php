...
class Equipment extends Model
{
    ...
    public function interventions()
    {
        return $this->belongsToMany(Intervention::class)
            ->withPivot('inspection', 'raw_recharge', 'nitrogen_recharge', 'maintenance', 'additional_maintenance', 'supply', 'accessory', 'equipment_protection_id', 'equipment_protection_name', 'equipment_status');
    }
