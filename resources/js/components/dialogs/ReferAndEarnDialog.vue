    ...
    <VCard class="refer-and-earn-dialog">
      <VCardText class="px-5 px-sm-16 pt-16 pb-10">
        ...
        <p class="text-sm-body-1 text-center">
          Invite your friend to WAVE PLUS, if they sign up, you and your friend will get 30 days free trial
        </p>
      ...
      <VCardText class="px-5 px-sm-16 pt-10 pb-16">
        ...
        <p class="mb-1 text-sm">
          Enter your friend's email address and invite them to join WAVE PLUS 😍
        </p>
        <VForm
