<script setup>
import BasicMissionInformation from '@/views/client/mission/edit/BasicMissionInformation.vue'
import MissionMonitoring from '@/views/client/mission/edit/MissionMonitoring.vue'
import MissionParams from '@/views/client/mission/edit/MissionParams.vue'

// import ServiceDeliveryNote from '@/views/client/mission/edit/ServiceDeliveryNote.vue'
import { useMissionListStore } from '@/views/client/mission/useMissionListStore'
        ...
        >
          ...
          <VWindowItem>
            <MissionParams
              ...
              :service-headers="serviceHeaders"
              @submit="updateMission"
            />
          </VWindowItem>
          <VWindowItem>
