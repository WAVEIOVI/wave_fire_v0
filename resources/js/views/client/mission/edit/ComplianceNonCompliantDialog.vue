...
const fetchCompliancesOptions = () => {
  missionParamsStore.fetchCompliancesNonCompliant({
    ...
    <VCard class="pa-sm-8 pa-5">
      <VCardItem class="text-center">
        <VCardTitle class="text-h3 mb-3">
          Compliances (Non-Compliant)
        </VCardTitle>
      </VCardItem>
      <VCardText class="mt-6">
        <VRow>
          <VCol cols="12">
            <VCard title="Attach A Non-Compliant Point With Mission Report">
              <VCardText class="mt-6">
                <VForm
                  class="mt-4"
        ...
        <VRow>
          <VCol cols="12">
            <VCard title="Non-Compliant List">
              <VDivider />
