...
export const useMissionParamsStore = defineStore('MissionParamsStore', {
  actions: {
    ...
    //SECTION Compliance API CALL
    // 👉 Fetch Compliances data
    ...
    addCompliance(complianceData) {
      return new Promise((resolve, reject) => {
        axios
          .post('/api/compliances', complianceData)
          .then(response => resolve(response))
          .catch(error => reject(error))
      })
    },
    ...
    // 👉 update Compliance
    updateCompliance(id, complianceData) {
      return new Promise((resolve, reject) => {
        axios
          .patch(`/api/compliances/${id}`, complianceData)
          .then(response => resolve(response))
          .catch(error => reject(error))
      })
    },
