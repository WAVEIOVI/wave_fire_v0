...
const isRemoveClientDialogVisible = ref(false)
        ...
        <VCard title="Clients">
          ...
          >
            ...
            <template #[`item.actions`]="{ item }">
              ...
              <IconBtn
                :disabled="isRemoveClientDialogVisible"
                @click="isRemoveClientDialogVisible = true"
              >
                <VIcon icon="tabler-trash" />
              </IconBtn>"
              <VDialog
                v-model="isRemoveClientDialogVisible"
                persistent
                class="v-dialog-sm"
              >
                <DialogCloseBtn @click="isRemoveClientDialogVisible = !isRemoveClientDialogVisible" />
                ...
                <VCard title="Confirm Client Removal">
                  ...
                  <VCardText class="d-flex justify-end gap-3 flex-wrap">
                    <VBtn
                      color="secondary"
                      variant="tonal"
                      @click="isRemoveClientDialogVisible = false"
                    >
                      Cancel
                    </VBtn>
                    <VBtn
                      color="error" 
                      @click="isRemoveClientDialogVisible = false, deleteClient(item.raw.id)"
                    >
                      Confirm
                      <VIcon
                        end
