...
const isRemoveSupplierDialogVisible = ref(false)
        ...
        <VCard title="Suppliers">
          ...
          >
            ...
            <template #[`item.actions`]="{ item }">
              ...
              <IconBtn
                :disabled="isRemoveSupplierDialogVisible"
                @click="isRemoveSupplierDialogVisible = true"
              >
                <VIcon icon="tabler-trash" />
              </IconBtn>"
              <VDialog
                v-model="isRemoveSupplierDialogVisible"
                persistent
                class="v-dialog-sm"
              >
                <DialogCloseBtn @click="isRemoveSupplierDialogVisible = !isRemoveSupplierDialogVisible" />

                <VCard title="Confirm Client Removal">
                  <VCardText>
                  ...
                  <VCardText class="d-flex justify-end gap-3 flex-wrap">
                    <VBtn
                      color="secondary"
                      variant="tonal"
                      @click="isRemoveSupplierDialogVisible = false"
                    >
                      Cancel
                    </VBtn>
                    <VBtn
                      color="error" 
                      @click="isRemoveSupplierDialogVisible = false, deleteSupplier(item.raw.id)"
                    >
                      Confirm
                      <VIcon
                        end
