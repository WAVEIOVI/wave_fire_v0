...
const isRemoveAreaDialogVisible = ref(false)
...
const isCollapsed = ref(false) // Set to true to make it initially collapsed
</script>
            ...
            >
              <VListItem>
                ...
                <template #append>
                  ...
                  <IconBtn 
                    :disabled="isRemoveAreaDialogVisible"
                    @click="isRemoveAreaDialogVisible = true"
                  >
                    <VIcon icon="tabler-trash" />
                  </IconBtn>
                  <VDialog
                    v-model="isRemoveAreaDialogVisible"
                    persistent
                    class="v-dialog-sm"
                  >
                    <DialogCloseBtn @click="isRemoveAreaDialogVisible = !isRemoveAreaDialogVisible" />

                    <VCard title="Confirm Area Removal">
                      <VCardText>
                        Are you sure you want to remove this area? This action cannot be undone.
                      </VCardText>
                      ...
                      <VCardText class="d-flex justify-end gap-3 flex-wrap">
                        <VBtn
                          color="secondary"
                          variant="tonal"
                          @click="isRemoveAreaDialogVisible = false"
                        >
                          Cancel
                        </VBtn>
                        <VBtn
                          color="error"
                          @click="isRemoveAreaDialogVisible = false, deleteArea(area.id)"
                        >
                          Confirm
                          <VIcon
                            end
