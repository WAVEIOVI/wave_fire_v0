...
const isRemoveEquipmentDialogVisible = ref(false)
        ...
        <VCard title="Park Equipments">
          ...
          >
            ...
            <template #[`item.area`]="{ item }">
              <div class="d-flex align-center">
                <div class="d-flex flex-column">
                  <h6 class="text-base font-weight-medium user-list-name text-uppercase">
                    {{ item.raw.equipment_area_description }} 
                  </h6>

                  <span class="text-sm text-medium-emphasis text-uppercase">{{ item.raw.equipment_area }}</span>
                </div>
              </div>
            </template>
            <!-- 👉 Category -->
            ...
            <template #[`item.actions`]="{ item }">
              ...
              <IconBtn 
                :disabled="isRemoveEquipmentDialogVisible"
                @click="isRemoveEquipmentDialogVisible = true"
              >
                <VIcon icon="tabler-trash" />
              </IconBtn>
              <VDialog
                v-model="isRemoveEquipmentDialogVisible"
                persistent
                class="v-dialog-sm"
              >
                <DialogCloseBtn @click="isRemoveEquipmentDialogVisible = !isRemoveEquipmentDialogVisible" />

                <VCard title="Confirm Equipment Removal">
                  <VCardText>
                  ...
                  <VCardText class="d-flex justify-end gap-3 flex-wrap">
                    <VBtn
                      color="secondary"
                      variant="tonal"
                      @click="isRemoveEquipmentDialogVisible = false"
                    >
                      Cancel
                    </VBtn>
                    <VBtn 
                      color="error"
                      @click="isRemoveEquipmentDialogVisible = false, deleteEquipment(item.raw.id)"
                    >
                      Confirm
                      <VIcon
                        end
