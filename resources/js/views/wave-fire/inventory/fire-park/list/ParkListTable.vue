...
const isRemoveParkDialogVisible = ref(false)
        ...
        <VCard title="Parks">
          ...
          >
            ...
            <template #[`item.actions`]="{ item }">
              ...
              <IconBtn
                :disabled="isRemoveParkDialogVisible"
                @click="isRemoveParkDialogVisible = true"
              >
                <VIcon icon="tabler-trash" />
              </IconBtn>
              <VDialog
                v-model="isRemoveParkDialogVisible"
                persistent
                class="v-dialog-sm"
              >
                <DialogCloseBtn @click="isRemoveParkDialogVisible = !isRemoveParkDialogVisible" />

                <VCard title="Confirm Park Removal">
                  <VCardText>
                    Are you sure you want to remove this park? This action cannot be undone.
                  </VCardText>
                  ...
                  <VCardText class="d-flex justify-end gap-3 flex-wrap">
                    <VBtn
                      color="secondary"
                      variant="tonal"
                      @click="isRemoveParkDialogVisible = false"
                    >
                      Cancel
                    </VBtn>
                    <VBtn
                      color="error"
                      @click="isRemoveParkDialogVisible = false, deletePark(item.raw.id)"
                    >
                      Confirm
                      <VIcon
                        end
