              ...
              <div class="d-flex align-center">
                <div class="d-flex flex-column">
                  <h6 class="text-base text-uppercase">
                    {{ item.raw.qrc_id }} | {{ item.raw.internal_id }} <span class="text-sm text-medium-emphasis">{{ item.raw.equipment_category }} {{ item.raw.equipment_model }} {{ item.raw.equipment_weight_value }} {{ item.raw.equipment_weight_unit }} {{ item.raw.equipment_pressure }}</span>
                  </h6>
                </div>
              </div>
            </template>
