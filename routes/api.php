...
use App\Http\Controllers\Api\WaveFire\Mission\MissionsRecommendationsController;
use App\Http\Controllers\Api\WaveFire\Mission\MissionsCompliancesController;
use App\Http\Controllers\Api\WaveFire\Mission\MissionsStandardsController;
use App\Http\Controllers\Api\WaveFire\Mission\MissionsServicesController;
use App\Http\Controllers\Api\WaveFire\Mission\MissionHazardsController;
use App\Http\Controllers\Api\WaveFire\Mission\MissionsSuggestionsController;
use App\Http\Controllers\Api\WaveFire\Mission\MissionOutOfServicesController;
...
use App\Http\Controllers\Api\Config\Mission\StandardsController;
use App\Http\Controllers\Api\Config\Mission\RecommendationsController;
use App\Http\Controllers\Api\Config\Mission\CompliancesController;
use App\Http\Controllers\Api\Config\Mission\MissionServicesController;
use App\Http\Controllers\Api\Config\Mission\HazardsController;
use App\Http\Controllers\Api\Config\Mission\SuggestionsController;
...
Route::group(['as' => 'api.', 'middleware' => 'auth:sanctum'], function () {
    ...
    Orion::belongsToManyResource('missions', 'standards', MissionsStandardsController::class);
    Orion::belongsToManyResource('missions', 'recommendations', MissionsRecommendationsController::class);
    Orion::belongsToManyResource('missions', 'suggestions', MissionsSuggestionsController::class);
    Orion::belongsToManyResource('missions', 'compliances', MissionsCompliancesController::class);
    Orion::belongsToManyResource('missions', 'services', MissionsServicesController::class);
    Orion::hasManyResource('missions', 'hazards', MissionHazardsController::class);
    Orion::hasManyResource('missions', 'out-of-services', MissionOutOfServicesController::class);
    ...
    Orion::resource('standards', StandardsController::class);
    Orion::resource('recommendations', RecommendationsController::class);
    Orion::resource('suggestions', SuggestionsController::class);
    Orion::resource('compliances', CompliancesController::class);
    Orion::resource('mission-services', MissionServicesController::class);
    Orion::resource('hazards', HazardsController::class);
